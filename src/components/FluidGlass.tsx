  ...
  useFrame(() => {
    if (group.current && group.current.children.length > 0) {
      if (group.current.children[0]?.material) {
        (group.current.children[0].material as ZoomMaterial).zoom = 1 + data.range(0, 1 / 3) / 3;
      }
      if (group.current.children[1]?.material) {
        (group.current.children[1].material as ZoomMaterial).zoom = 1 + data.range(0, 1 / 3) / 3;
      }
      if (group.current.children[2]?.material) {
        (group.current.children[2].material as ZoomMaterial).zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2;
      }
      if (group.current.children[3]?.material) {
        (group.current.children[3].material as ZoomMaterial).zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2;
      }
      if (group.current.children[4]?.material) {
        (group.current.children[4].material as ZoomMaterial).zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2;
      }
    }
  });
